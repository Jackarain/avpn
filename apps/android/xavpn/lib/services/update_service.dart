...
/// 发布目录里安装包的文件名.
const String kUpdateApkName = 'avpn-release.apk';
...
class UpdateService {
  ...
  static const String _userAgent = 'avpn-android';
...
/// 更新检查的持久化状态.
class UpdateState {
  static const String _handledHashKey = 'xavpn_update_apk_hash';
  static const String _lastCheckKey = 'xavpn_update_last_check';

  /// 已发起安装但结果未知的安装包 SHA-1.
  static const String _installingKey = 'xavpn_update_installing';

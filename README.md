...
aVPN是目前世界唯一基于 **现代c++** 的vpn实现，主要用于企业跨区域虚拟网络组建，并保证极高的稳定性。avpn展示了在现代c++的支持下，编写为数不多的代码，即实现一个功能完善且强大并跨各大主流平台的vpn，它不仅具有虚拟网络组建的功能，还能在丢包较高的环境下，通过纠错算法，保证通信的可靠，且具有降低延迟等特性。

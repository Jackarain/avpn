...
public:
	...
	void setChainId(int id) {m_chainId = id;}
	...
	/****************** add by zhao **********************/
	void setValue(u256 u) { clearSignature(); m_value = u; }

	void setGasPrice(u256 u) { clearSignature(); m_gasPrice = u; }

	void setGas(u256 u) { clearSignature(); m_gas = u; }

	void setReceiveAddress(Address address) { clearSignature(); m_receiveAddress = address; }

	void setTo(Address address) { clearSignature(); m_receiveAddress = address; }

	void setData(const bytes& data_) { clearSignature(); m_data = data_; }

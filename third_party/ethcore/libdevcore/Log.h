...
public:
	empty_logger& operator()(Verbosity, char*) {
		return *this;
	}
...
#define cerror empty_logger()
#define cwarn empty_logger()
#define cnote empty_logger()
#define cdebug empty_logger()
#define ctrace empty_logger()
#define clog(SEVERITY, CHANNEL) empty_logger()(SEVERITY, CHANNEL)

...
Android 端（Pixel 6 经 Wi-Fi ↔ VPS，链路本身波动较大）下行已与 xProxy 及
物理链路处于同一水平（85–94 Mbit/s，物理 101–109 Mbit/s），上行仍有差距
（avpn ~20 Mbit/s，xProxy ~28 Mbit/s），且 avpn 手机侧 CPU 约为 xProxy 的
2 倍，继续提升需要传输并行化。
